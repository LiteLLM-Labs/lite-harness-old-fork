            ...
            >
              <div className="min-w-0 flex-1">
                ...
                <div className="font-mono text-[10px] text-muted-foreground truncate">
                  {(s.agent ?? s.harness) === "claude-code" ? "cc" : (s.agent ?? s.harness) === "github-copilot" ? "gh" : (s.agent ?? s.harness) === "hermes" ? "hr" : (s.agent ?? s.harness) === "codex" ? "cx" : "oc"} · {short} · {timeAgo(s.time?.created)}
                </div>
              </div>
              <button
